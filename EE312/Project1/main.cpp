...
void blankTest(void) {
	...
	char dictionary[] = "";
	char article[] = "";
	spellCheck(article, dictionary); // should print: nothing
	printf("****DONE****\n");
}

void blankTest2(void) {
	printf("\n\n******* Starting Blank Test 2 *******\n");
...
void blankTest3(void) {
	printf("\n\n******* Starting Blank Test 3 *******\n");
	char dictionary[] = "";
	char article[] = "I was close to writing curses in this test. Sorry.!!!!!.a.?a";
	spellCheck(article, dictionary); // should print: nothing
	printf("****DONE****\n");
}
