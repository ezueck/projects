...
double mat3[] = { 1,2,3,4,5,6,7,8 };
double* matlist[] = { &mat1[0], &mat2[0], &mat3[0] };
unsigned int rows[] = { 3,3,4 };
unsigned int cols[] = { 3,4,2 };
double out[8];

int main(void) {
	testStage1();
//	multiplyMatrixChain(matlist, rows, cols, 3, out, 3, 2);
	testStage2();
	testStage3();
	return 0;
}
